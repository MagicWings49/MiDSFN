...
#Parameters setting: --cfg "configs/MiDSFN.yaml" --data "drug_microbe" --split "MDAD_aBiofilm" or "MDAD+aBiofilm"
...
dataFolder = os.path.join(dataFolder, str(args.split) + "_discard")
...
print('Test '+ 'discard' + ' part at Model' + ' with test loss ' + str(test_loss),
...
res.append(['Disarded_part', auroc, auprc, np.max(f1[5:]), sensitivity, specificity, accuracy, test_loss, thred_optim, precision1])
...
workbook.save(result_path + "/Test_on_discarded_part.xlsx")
